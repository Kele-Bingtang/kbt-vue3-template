...
export const errorRouter: RouterConfigRaw[] = [
  {
    path: "/403",
    name: "403",
    component: () => import("@template/components/error/src/403.vue"),
    meta: {
      title: "403 页面",
    },
  },
  {
    path: "/404",
    name: "404",
    component: () => import("@template/components/error/src/404.vue"),
    meta: {
      title: "404 页面",
    },
  },
  {
    path: "/500",
    name: "500",
    component: () => import("@template/components/error/src/500.vue"),
    meta: {
      title: "500 页面",
    },
  },
